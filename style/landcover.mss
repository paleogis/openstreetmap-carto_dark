...
@grass: #7a7a7a;        // Lch(90,32,128) also grassland, meadow, village_green, garden, allotments
@scrub: #7a7a7a;        // Lch(84,24,122)
@forest: #7a7a7a;       // Lch(80,30,135)
@forest-text: #080808;  // Lch(40,30,135)
@park: #7a7a7a;         // Lch(94,30,145)
@allotments: #7a7a7a;   // Lch(87,20,135)
@orchard: #7a7a7a; // also vineyard, plant_nursery
@hedge: @forest;       // Lch(80,30,135)

// --- "Base" landuses ---

@built-up-lowzoom: #545454;
@built-up-z12: #545454;
@residential: #545454;      // Lch(89,0,0)
@residential-line: #545454; // Lch(75,0,0)
@retail: #545454;           // Lch(89,16,30)
@retail-line: #545454;      // Lch(70,25,30)
@commercial: #545454;       // Lch(89,8.5,25)
@commercial-line: #545454;  // Lch(75,12,25)
@industrial: #545454;       // Lch(89,9,330) (Also used for railway, wastewater_plant)
@industrial-line: #545454;  // Lch(75,11,330) (Also used for railway-line, wastewater_plant-line)
@farmland: #545454;         // Lch(94,14,112)
@farmland-line: #545454;    // Lch(80,14,112)
@farmyard: #545454;         // Lch(89,20,80)
@farmyard-line: #545454;    // Lch(75,25,80)

// --- Transport ----

@transportation-area: #545454;
@apron: #545454;
@garages: #545454;
@parking: #545454;
...
@rest_area: #545454; // also services

// --- Other ----

@bare_ground: #545454;
@campsite: #545454; // also caravan_site, picnic_site
@cemetery: #545454; // also grave_yard
@construction: #545454; // also brownfield
@heath: #545454;
@mud: rgba(203,177,154,0.3); // produces #e6dcd1 over @land
@place_of_worship: #545454; // also landuse_religious
@place_of_worship_outline: darken(@place_of_worship, 30%);
@leisure: lighten(@park, 5%);
@power: darken(@industrial, 5%);
@power-line: darken(@industrial-line, 5%);
@sand: #545454;
@societal_amenities: #545454;   // Lch(99,13,109)
@tourism: #545454;
@quarry: #545454;
@military: #545454;
@beach: #545454;
...
@pitch: #545454;           // Lch(83,35,166) also track
@track: @pitch;
