@marina-text: #222222; // also swimming_pool
@wetland-text: darken(#222222, 25%); /* Also for mud */
@shop-icon: #222222;
@shop-text: #222222;
@transportation-icon: #222222;
@transportation-text: #222222;
@accommodation-icon: @transportation-icon;
@accommodation-text: @transportation-text;
@airtransport: #222222; //also ferry_terminal
@health-color: #222222;
@amenity-brown: #222222;
@gastronomy-icon: #222222;
@gastronomy-text: darken(@gastronomy-icon, 5%);
@memorials: @amenity-brown;
@culture: @amenity-brown;
@public-service: @amenity-brown;
@office: #222222;
@man-made-icon: #222222;
@advertising-grey: @man-made-icon;
@barrier-icon: #222222;
@landform-color: #222222;
@leisure-green: darken(@park, 60%);
@protected-area: #222222;
@aboriginal: #222222;
@religious-icon: #222222;
...
#trees [zoom >= 16] {
  ...
  [natural = 'tree']::trunk {
    [zoom >= 18] {
      trunk/opacity: 0.4;
      trunk/marker-fill: #181818; // Same opacity and color as forest svg patterns
